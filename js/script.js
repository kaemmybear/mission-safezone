document.querySelectorAll('.circle').forEach(function(circle) {
    circle.addEventListener('click', function() {
        let imageSrc = ''; // ค่าเริ่มต้นของรูป

        // ลบ class active ออกจากทุกวงกลมก่อน
        document.querySelectorAll('.circle').forEach(c => c.classList.remove('active'));

        // เพิ่ม class active ให้กับวงกลมที่ถูกคลิก
        this.classList.add('active');

        // ตรวจสอบว่า id ของวงกลมคืออะไรและกำหนดรูปภาพที่จะใช้
        switch (this.id) {
            case 'head':
                imageSrc = 'assets/sign/head.png';
                break;
            case 'hand1':
                imageSrc = 'assets/sign/hand.png';
                break;
            case 'hand2':
                imageSrc = 'assets/sign/hand.png';
                break;
            case 'mouth':
                imageSrc = 'assets/sign/mouth.png';
                break;
            case 'face':
                imageSrc = 'assets/sign/face.png';
                break;
            case 'neck':
                imageSrc = 'assets/sign/neck.png';
                break;
            case 'shoulder1':
                imageSrc = 'assets/sign/shoulder.png';
                break;
            case 'shoulder2':
                imageSrc = 'assets/sign/shoulder.png';
            break;
            case 'chest':
                imageSrc = 'assets/sign/chest.png';
            break;
            case 'belly':
                imageSrc = 'assets/sign/belly.png';
             break;
             case 'sex':
                imageSrc = 'assets/sign/sex.png';
            break;
            case 'thigh1':
                imageSrc = 'assets/sign/leg.png';
            break;
            case 'thigh2':
                imageSrc = 'assets/sign/leg.png';
            break;
            case 'foot1':
                imageSrc = 'assets/sign/foot.png';
            break;
            case 'foot2':
                imageSrc = 'assets/sign/foot.png';
            break;
            ...
            case 'back-shoulder2':
                ...
                break;
            case 'back-back':
                imageSrc = 'assets/sign/back.png';
                break;
            case 'back-butt':
                imageSrc = 'assets/sign/butt.png';
                break;
            case 'back-hand1':
                imageSrc = 'assets/sign/hand.png';
                break;
...
function closePopup() {
    ...
    // ลบ class active ออกจากทุกวงกลม
    document.querySelectorAll('.circle').forEach(c => c.classList.remove('active'));
}

// สร้างฟังก์ชันเพื่อปิด popupIn
