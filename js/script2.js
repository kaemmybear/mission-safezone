const items = {
    hair: [
        { front: "hair1_front.png", back: "hair1_back.png" },
        { front: "hair2_front.png", back: "hair2_back.png" },
        { front: "hair3_front.png", back: "hair3_back.png" },
        { front: "hair4_front.png", back: "hair4_back.png" }
    ],
    outfit: ["outfit1.png", "outfit2.png", "outfit3.png", "outfit4.png"],
    shoes: ["shoes1.png", "shoes2.png", "shoes3.png", "shoes4.png"],
    accessory: ["accessory1.png", "accessory2.png", "accessory3.png", "accessory4.png"]
};
...
function changeItem(type) {
    indices[type] = (indices[type] + 1) % items[type].length;

    // If it's hair, update both front and back
    if (type === "hair") {
        document.getElementById("hair_front").src = "assets/dressup/" + items.hair[indices[type]].front;
        document.getElementById("hair_back").src = "assets/dressup/" + items.hair[indices[type]].back;
    } else {
        document.getElementById(type).src = "assets/dressup/" + items[type][indices[type]];
    }
}
...
function goToPage2() {
    // โหลดเนื้อหา page2 ของคุณ (ตามที่ทำอยู่)
    
    // แล้วค่อยเล่นเพลง
    const audio = document.getElementById('background-music');
    if (audio) {
      audio.play().catch((e) => {
        console.log('User interaction needed before playing audio.', e);
      });
    }
  }
  ...
  function showPage(pageId) {
    ...
    // แสดงหน้าใหม่ที่ต้องการ
    document.getElementById(pageId).classList.add('active');

    if (pageId === 'page2') {
        manager.addConfetti();

        // เล่นเพลงเฉพาะตอนเข้า page2
