// แทนที่การประกาศตัวแปรซ้ำ
let steps = document.querySelectorAll('.step-image'); // ประกาศแค่ครั้งเดียว
let currentStep = 0;

// ฟังก์ชันเพื่อแสดงภาพถัดไป
function showNextStep() {
  // ซ่อนภาพทั้งหมดก่อน (ลบคลาส 'active' ออกจากภาพทั้งหมด)
  steps.forEach(step => step.classList.remove('active'));

  // แสดงภาพปัจจุบัน (เพิ่มคลาส 'active' ให้กับภาพที่ต้องการ)
  steps[currentStep].classList.add('active');

  // เตรียมขั้นตอนถัดไป (ถ้ามาถึงภาพสุดท้ายจะวนกลับไปเริ่มที่ภาพแรก)
  currentStep = (currentStep + 1) % steps.length;
}

// เรียกใช้ฟังก์ชัน showNextStep ทุกๆ 2 วินาที
